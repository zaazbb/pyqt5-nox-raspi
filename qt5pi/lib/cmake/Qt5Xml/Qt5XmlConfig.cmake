...
set(Qt5Xml_VERSION_STRING 5.6.4)
...
if (NOT TARGET Qt5::Xml)
    ...
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/include/QtXml/5.6.4"
        "${_qt5Xml_install_prefix}/include/QtXml/5.6.4/QtXml"
    )
    ...
    foreach(_module_dep ${_Qt5Xml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.4 ${_Qt5Xml_FIND_VERSION_EXACT}
    ...
    _populate_Xml_target_properties(RELEASE "libQt5Xml.so.5.6.4" "" )
