...
set(Qt5Network_VERSION_STRING 5.6.4)
...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/QtNetwork/5.6.4"
        "${_qt5Network_install_prefix}/include/QtNetwork/5.6.4/QtNetwork"
    )
    ...
    foreach(_module_dep ${_Qt5Network_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.4 ${_Qt5Network_FIND_VERSION_EXACT}
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network.so.5.6.4" "" )
